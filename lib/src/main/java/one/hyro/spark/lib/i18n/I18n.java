...
public class I18n {
    public static void setupInternationalization() {
        ...
        ResourceBundle bundleDE = ResourceBundle.getBundle("i18n.de", Locale.forLanguageTag("de"), UTF8ResourceBundleControl.get());
        registry.registerAll(Locale.ENGLISH, bundleEN, true);
        registry.registerAll(Locale.forLanguageTag("es"), bundleES, true);
        registry.registerAll(Locale.forLanguageTag("de"), bundleDE, true);
